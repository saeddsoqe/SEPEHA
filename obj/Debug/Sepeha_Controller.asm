...
; This file was generated Sun May 01 15:21:23 2022
;--------------------------------------------------------
; PIC port for the 14-bit core
;--------------------------------------------------------
	.file	"Sepeha_Controller.c"
	list	p=16f877a
	radix dec
...
; global declarations
;--------------------------------------------------------
	global	_SEPEHA_GetValue
	global	_SEPEHA_Update
	global	_SEPEHA_init
...
;--------------------------------------------------------
UDL_Sepeha_Controller_0	udata
r0x1006	res	1
_counter	res	2
_SEPEHA_Update_Sep_Counter_1_15	res	2
;--------------------------------------------------------
; initialized data
;--------------------------------------------------------
;--------------------------------------------------------
...
; code
;--------------------------------------------------------
code_Sepeha_Controller	code
;***
;  pBlock Stats: dbName = C
;***
;entry:  _SEPEHA_GetValue	;Function start
; 2 exit points
;has an exit
...
;; ***	genFunction  2342 curr label offset=8previous max_key=19 
_SEPEHA_GetValue	;Function start
; 2 exit points
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;; 	line = 6937 result AOP_REG=r0x104B, size=2, left -=-, size=0, right AOP_DIR=_counter, size=2
;; ***	genAssign  7023
...
;;	1109 rIdx = r0x104B 
;;103	MOVF	r0x1004,W
	.line	62; "Sepeha_Controller.c"	return count;
	BANKSEL	_counter
	MOVF	_counter,W
...
;; ***	genEndFunction  2530
	RETURN	
; exit point of _SEPEHA_GetValue

;***
;  pBlock Stats: dbName = C
;***
;entry:  _SEPEHA_Update	;Function start
; 2 exit points
;has an exit
;functions called:
;   _SW_GetState
...
_SEPEHA_Update	;Function start
; 2 exit points
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;; ***	genPlus  611
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:612:genPlus *{*
;; ***	aopForSym 315
;;	327 sym->rname = _SEPEHA_Update_Sep_Counter_1_15, size = 2
;;	575
;; 	line = 618 result AOP_DIR=_SEPEHA_Update_Sep_Counter_1_15, size=2, left AOP_DIR=_SEPEHA_Update_Sep_Counter_1_15, size=2, right AOP_LIT=0x05, size=2
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:344:genAddLit
	.line	34; "Sepeha_Controller.c"	Sep_Counter += TMR_TICK_MS;
	MOVLW	0x05
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/genarith.c:345:genAddLit
;;	1009
;;	1028  _SEPEHA_Update_Sep_Counter_1_15   offset=0
	BANKSEL	_SEPEHA_Update_Sep_Counter_1_15
	ADDWF	_SEPEHA_Update_Sep_Counter_1_15,F
...
;;	1009
;;	1028  _SEPEHA_Update_Sep_Counter_1_15   offset=1
	INCF	(_SEPEHA_Update_Sep_Counter_1_15 + 1),F
;; ***	addSign  861
...
;; ***	aopForSym 315
;;	327 sym->rname = _SEPEHA_Update_Sep_Counter_1_15, size = 2
;; 	line = 3631 result AOP_CRY=0x00, size=0, left AOP_DIR=_SEPEHA_Update_Sep_Counter_1_15, size=2, right AOP_LIT=0x14, size=2
;; ***	mov2w  1381  offset=0
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1386:mov2w
;;	1009
;;	1028  _SEPEHA_Update_Sep_Counter_1_15   offset=0
	.line	36; "Sepeha_Controller.c"	if (Sep_Counter != SEPEHA_PERIOD_MS)
	MOVF	_SEPEHA_Update_Sep_Counter_1_15,W
...
;;	1009
;;	1028  _SEPEHA_Update_Sep_Counter_1_15   offset=1
	MOVF	(_SEPEHA_Update_Sep_Counter_1_15 + 1),W
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:3685:genCmpEq
	.line	38; "Sepeha_Controller.c"	return;
	XORLW	0x00
	.line	41; "Sepeha_Controller.c"	Sep_Counter = 0;
	BTFSS	STATUS,2
_00127_DS_
	GOTO	_00116_DS_
	BANKSEL	_SEPEHA_Update_Sep_Counter_1_15
	CLRF	_SEPEHA_Update_Sep_Counter_1_15
	CLRF	(_SEPEHA_Update_Sep_Counter_1_15 + 1)
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2316:resultRemat *{*
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1361:mov2w_op
	.line	42; "Sepeha_Controller.c"	if (SW_GetState(SW_INCREMENT) == SW_PRE_PRESSED)
	MOVLW	0x00
...
;;	1009
;;	1028  _counter   offset=0
	.line	44; "Sepeha_Controller.c"	counter ++;
	BANKSEL	_counter
	INCF	_counter,F
...
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:1361:mov2w_op
_00114_DS_
	.line	46; "Sepeha_Controller.c"	else if (SW_GetState(SW_RESET) == SW_PRE_PRESSED)
	MOVLW	0x01
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2173:genCall
	PAGESEL	_SW_GetState
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:2175:genCall
...
;;	1009
;;	1028  _counter   offset=0
	.line	48; "Sepeha_Controller.c"	counter = 0;
	BANKSEL	_counter
	CLRF	_counter
;; ***	genAssign  7023
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7035:genAssign
...
;;	1009
;;	1028  _counter   offset=0
	.line	23; "Sepeha_Controller.c"	counter = 0;
	BANKSEL	_counter
	CLRF	_counter
;; ***	genAssign  7023
;; >>> /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7035:genAssign
...
;; ***	genEndFunction  2530
	RETURN	
; exit point of _SEPEHA_init
;;; /home/sdcc-builder/build/sdcc-build/orig/sdcc/src/pic14/gen.c:7426:genpic14Code *{*


;	code size estimation:
;	   40+   12 =    52 instructions (  128 byte)
